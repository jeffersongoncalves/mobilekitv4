...
class AppServiceProvider extends ServiceProvider
{
    ...
    private function configureSchema(): void
    {
        Schema::configureUsing(function (Schema $schema) {
            return $schema
                ->defaultCurrency(config('mobilekit.defaultCurrency'))
                ->defaultDateDisplayFormat(config('mobilekit.defaultDateDisplayFormat'))
                ->defaultIsoDateDisplayFormat(config('mobilekit.defaultIsoDateDisplayFormat'))
                ->defaultDateTimeDisplayFormat(config('mobilekit.defaultDateTimeDisplayFormat'))
                ->defaultIsoDateTimeDisplayFormat(config('mobilekit.defaultIsoDateTimeDisplayFormat'))
                ->defaultNumberLocale(config('mobilekit.defaultNumberLocale'))
                ->defaultTimeDisplayFormat(config('mobilekit.defaultTimeDisplayFormat'))
                ->defaultIsoTimeDisplayFormat(config('mobilekit.defaultIsoTimeDisplayFormat'));
        });
    }
